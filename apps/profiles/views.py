...
def get_all_agents(request):
    ...
    name_space_response = {"agents": serializer.data}
    return Response(name_space_response, status=status.HTTP_200_OK)
"""


class TopAgentsListView(generics.ListAPIView):
    permission_classes = [permissions.IsAuthenticated]
...
class UpdateProfileAPIView(APIView):
    ...
    def patch(self, request, username):
        ...
        user_nsme = request.user.username
        if user_nsme != username:
