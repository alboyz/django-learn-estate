...
class PropertyPublishedManager(models.Manager):
    ...
    def get_queryset(self):
        return (super(PropertyPublishedManager,
                      self).get_queryset().filter(published_status=True))


class Property(TimeStampedUUIDModel):

    class AdvertType(models.TextChoices):
        FOR_SALE = 'For Sale', _('For_Sale')
        FOR_RENT = 'For_Rent', _('For_Rent')
        AUCTION = 'Aution', _('Aution')

    class PropertyType(models.TextChoices):
        HOUSE = 'House', _('House')
        APARTEMENT = 'Apartement', _('Apartement')
    ...
    description = models.TextField(
        ...
        default='Description Update Me Please...',
    )
    ...
    bathrooms = models.DecimalField(verbose_name=_('Bathrooms'),
                                    max_digits=4,
                                    decimal_places=2,
                                    default=1.0)
    ...
    cover_photo = models.ImageField(verbose_name=_('Main Photo'),
