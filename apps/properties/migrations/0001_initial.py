# Generated by Django 4.0 on 2022-01-30 07:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Description Update Me Please...', verbose_name='Description')),
                ('country', django_countries.fields.CountryField(default='IND', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='New Delhi', max_length=180, verbose_name='city')),
                ('postal_code', models.CharField(default='140', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Subroto', max_length=150, verbose_name='Street Address')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, help_text='15% Property Tax Charged', max_digits=8, verbose_name='Tax')),
                ('plot_ara', models.DecimalField(decimal_places=2, default=6.0, max_digits=8, verbose_name='Plot Area(m^2)')),
                ...
                ('advert_type', models.CharField(choices=[('For Sale', 'For_Sale'), ('For_Rent', 'For_Rent'), ('Aution', 'Aution')], default='For Sale', max_length=50, verbose_name='Advert Type')),
                ('property_type', models.CharField(choices=[('House', 'House'), ('Apartement', 'Apartement'), ('Office', 'Office'), ('WhereHouse', 'WhereHouse'), ('Other', 'Other')], default='Other', max_length=50, verbose_name='Property Type')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='agent_buyer', to='users.user', verbose_name='Agent, Seller, or Buyer')),
            ],
            options={
